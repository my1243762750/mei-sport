export type BeatSoundType = 'tick' | 'drum' | 'bass' | 'woodblock' | 'cowbell' | 'chime' | 'sub_boom' | 'hihat' | 'blop1' | 'blop2' | 'blop3' | 'mellow' | 'pluck' | 'shaker' | 'rim' | 'snare' | 'maracas' | 'agogo' | 'tom_high';
